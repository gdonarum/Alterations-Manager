...
export default function NewAppointmentPage() {
  ...
  return (
    <div className="p-8 max-w-xl">
      <div className="mb-6">
        <Link href="/schedule" className="flex items-center gap-2 text-gray-500 hover:text-gray-700 text-sm mb-4">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Link href="/schedule" className="px-4 py-2 border border-gray-300 rounded-lg text-sm text-gray-600 hover:bg-gray-50">
            Cancel
          </Link>
        </div>
      </form>
