...
export default function LoginPage() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      console.error(err)
      setError('Sign in failed. Make sure you are using the authorized Google account.')
      setLoading(false)
    }
  }
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 w-full max-w-sm text-center">
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <div className="text-left">
            <h1 className="text-xl font-bold text-gray-900 leading-tight">Alterations</h1>
            <p className="text-sm text-gray-500">Manager</p>
          </div>
        </div>

        <p className="text-gray-600 text-sm mb-6">Sign in with your Google account to continue.</p>
